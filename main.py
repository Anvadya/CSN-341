...
flow_file_path = r"/Downloads/FlowTransformer/demonstration/dataset/fe6cb615d161452c_MOHANAD_A4706/data"

datasets = [
    # ("CSE_CIC_IDS", os.path.join(flow_file_path, "NF-CSE-CIC-IDS2018-v2.csv"),
    #  NamedDatasetSpecifications.unified_flow_format, 0.01, EvaluationDatasetSampling.LastRows),
    # ("NSL-KDD", os.path.join(flow_file_path, "NSL-KDD.csv"),
    #  NamedDatasetSpecifications.nsl_kdd, 0.05, EvaluationDatasetSampling.RandomRows),
    # ("UNSW_NB15", os.path.join(flow_file_path, "NF-UNSW-NB15-v2.csv"),
    #  NamedDatasetSpecifications.unified_flow_format, 0.025, EvaluationDatasetSampling.LastRows)
    ("UNSW_NB15", os.path.join(flow_file_path, "NF-UNSW-NB15-v2 - pcap.csv"),
     NamedDatasetSpecifications.unified_flow_format, 0.025, EvaluationDatasetSampling.LastRows)
]
...
(train_results, eval_results, final_epoch) = ft.evaluate(
    m, batch_size=128, epochs=5, steps_per_epoch=64, early_stopping_patience=5)
